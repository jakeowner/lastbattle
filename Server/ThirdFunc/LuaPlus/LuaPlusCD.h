...
namespace LPCD
{
	...
	static unsigned int convertVoidToUInt(void* pOffset)
	{
		if (NULL == pOffset){
			return 0;
		}
	...
	public:
		static int PropertyGet(lua_State* L)
		{
			...
			LPCD::Push(L, *(VarType*)((unsigned char*)obj + convertVoidToUInt(offset)));
		...
		static int PropertySet(lua_State* L)
		{
			...
			*(VarType*)((unsigned char*)obj + convertVoidToUInt(offset)) = Get(TypeWrapper<VarType>(), L, 2);
